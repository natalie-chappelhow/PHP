	...
	<div class="container">
		<div class="form">
			<form>
				...
				<input type="text" id="length" name="length" value="<?php if(isset($_GET["length"])){echo $_GET["length"];}?>" /> 


				<label for="numbers">numbers:</label>
				<input name="numbers" value="0" type="hidden">
				<input type="checkbox" id="numbers" name="numbers" value="" />



				<label for="symbols">symbols:</label>
				<input name="symbols" value="0" type="hidden">
				<input type="checkbox" id="symbols" name="symbols" value="" />
			...
			<p>Generated Friendly Password: <?php echo $password;?> </p>
